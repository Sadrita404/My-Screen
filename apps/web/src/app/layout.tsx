...
export const metadata: Metadata = {
  metadataBase: new URL("https://3000"),
  title: {
    default: "My Screen - Free Online Screen Recorder | No Download Required",
    template: "%s | My Screen",
  },
  description: "My Screen is a free, privacy-first online screen recorder that works directly in your browser. Record your screen, webcam, and audio without installing any software. Perfect for tutorials, presentations, demos, and meetings. No account required, instant recording, and full HD quality.",
  keywords: [
    "screen recorder",
  ...
  openGraph: {
    ...
    url: "https://3000/",
    siteName: "My Screen",
    title: "My Screen - Free Online Screen Recorder | No Download Required",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "My Screen - Free Online Screen Recorder",
        type: "image/png",
      },
    ],
  },
