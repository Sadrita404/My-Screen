...
import { X, ExternalLink, Bug, Lightbulb } from 'lucide-react';
...
export default function InfoButton() {
    ...
    // Note: To show this modal now, you would need to trigger setIsOpen(true) 
    // from a parent component or a different navigation element.
                ...
                >
                    ...
                    <div className="p-6">
                        ...
                        <div className="mb-4 space-y-2">
                            <a
                                href="Sadrita/issues/new?labels=bug&template=bug_report.md"
                                target="_blank"
                                rel="noopener noreferrer"
                            ...
                            <a
                                href="Sadrita/issues/new?labels=enhancement&template=feature_request.md"
                                target="_blank"
                                rel="noopener noreferrer"
